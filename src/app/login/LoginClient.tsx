      ...
      <div className="relative z-10 w-full max-w-[400px] animate-fade-in">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white px-8 py-10 shadow-sm">
          ...
          <div className="mb-8 text-center">
            <div className="mx-auto mb-5 h-12 w-12 rounded-xl bg-linear-to-br from-pink-500 via-purple-500 to-cyan-400 shadow-md shadow-purple-500/20" />
          ...
          <div className="flex flex-col gap-3">
            ...
            {successMessage && (
              <div className="rounded-lg bg-emerald-50 px-4 py-3 text-sm text-emerald-600 border border-emerald-100">
                {successMessage}
              </div>
            )}
            ...
            {currentProvider !== 'github' && (
              <button
                ...
                className="group relative flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 hover:shadow-md transition-all duration-200 active:scale-[0.98] disabled:opacity-60"
              >
                {loadingType === 'github' ? (
            ...
            {currentProvider !== 'guest' && (
              <button
                ...
                className="group relative flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-600 shadow-sm hover:bg-gray-100 hover:shadow-md transition-all duration-200 active:scale-[0.98] disabled:opacity-60"
              >
                {loadingType === 'guest' ? (
                  <div className="h-4 w-4 animate-spin rounded-full border-2 border-gray-300 border-t-gray-700" />
                ) : (
        ...
        <div className="mt-6 text-center">
          ...
          <a
            href="/privacy"
            className="mt-1.5 inline-block text-xs text-gray-400 hover:text-gray-600 transition-colors"
          >
            개인정보 처리방침
          </a>
        </div>
