      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50/50 p-3 shadow-sm">
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-md border border-gray-200 bg-white px-3 py-1.5 text-xs font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-50 disabled:opacity-50"
          >
