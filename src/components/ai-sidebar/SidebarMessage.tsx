...
import { Bot, Cpu, Maximize2, User } from 'lucide-react';
...
import { MessageDetailSheet } from '@/components/ai/MessageDetailSheet';
              ...
              <div className="mt-2 flex items-center gap-1">
                {canShowDetail && (
                  <button
                    ...
                    data-testid="message-detail-expand-button"
                  >
