  ...
  return (
    ...
    >
      <DialogPrimitive.Portal>
        ...
        >
          <div
            className="relative flex h-[94vh] w-[96vw] max-w-7xl flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl ring-1 ring-gray-100 animate-in fade-in zoom-in-95 duration-300"
            ...
            <div className="flex shrink-0 items-center justify-between border-b border-gray-100 bg-white/95 px-4 py-2.5 backdrop-blur-md sm:px-6">
              <div className="flex min-w-0 items-center gap-4">
                ...
                <div className="min-w-0">
                  <DialogPrimitive.Title className="truncate text-lg font-bold text-gray-900 tracking-tight">
                    온프레미스 DC1 서비스 토폴로지
                  </DialogPrimitive.Title>
                  <DialogPrimitive.Description className="text-[11px] text-gray-500">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <DialogPrimitive.Close
                  className="flex h-11 w-11 items-center justify-center rounded-lg text-gray-500 transition-all hover:bg-rose-50 hover:text-rose-600 cursor-pointer"
                  aria-label="닫기"
                >
                  <X size={20} />
                </DialogPrimitive.Close>
