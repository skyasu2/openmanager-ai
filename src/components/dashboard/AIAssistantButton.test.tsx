...
describe('AIAssistantButton', () => {
  ...
  it('renders correctly and displays button text', () => {
    render(<AIAssistantButton isOpen={false} isEnabled={false} onClick={mockOnClick} />);
  ...
  it('updates aria attributes and style when isOpen is true', async () => {
    render(<AIAssistantButton isOpen={true} isEnabled={false} onClick={mockOnClick} />);
  ...
  it('shows active indicator when isEnabled is true', async () => {
    const { container } = render(<AIAssistantButton isOpen={false} isEnabled={true} onClick={mockOnClick} />);
