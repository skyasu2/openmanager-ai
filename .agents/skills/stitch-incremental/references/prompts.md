...
```text
Suggest a small add-on UI block for [existing-page], without changing current API/state architecture.
Output should include placement, visual style, and interaction details only.
```
