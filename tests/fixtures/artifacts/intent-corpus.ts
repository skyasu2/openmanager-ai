...
export const artifactIntentCorpus = {
  ...
  cases: [
    ...
    {
      id: 'ss-009',
      query: '서버 상태 snapshot export',
      expected: 'server-snapshot',
      category: 'snapshot-artifact',
      note: '한국어 서버 상태 + 영어 snapshot export 요청',
    },
    {
      id: 'ss-010',
      ...
      expected: 'server-snapshot',
      category: 'snapshot-artifact',
      note: '영어 server status report download 요청',
    },
    {
      id: 'ss-011',
      query: '운영 상태 요약 카드 생성',
      expected: 'server-snapshot',
      category: 'snapshot-artifact',
      note: '운영 상태 요약 카드 생성 요청',
    },
    {
      id: 'ss-012',
      query: '인프라 상태 보고서 뽑아줘',
      expected: 'server-snapshot',
      category: 'snapshot-artifact',
      note: '인프라 상태 보고서 출력 요청',
    },
    {
      id: 'gd-001',
    ...
    },
    {
      ...
      expected: 'none',
      category: 'operational-chat',
      note: 'artifact-shaped 산출물 없는 서버 상태 질문',
    },
    {
      id: 'no-040',
      query: 'server status?',
      expected: 'none',
      category: 'operational-chat',
      note: '영어 서버 상태 질문은 snapshot artifact 실행 아님',
    },
    {
      id: 'no-041',
      query: '운영 상태 확인해줘',
      expected: 'none',
      category: 'operational-chat',
      note: '카드/리포트 없는 운영 상태 확인 요청',
    },
    {
      id: 'no-042',
      query: '서버 상태 스냅샷 말고 현재 상태만 알려줘',
      expected: 'none',
      category: 'negation',
      note: 'snapshot artifact 배제 후 일반 상태 질문',
    },
    {
      id: 'no-043',
      query: 'server status card 기능 설명해줘',
      expected: 'none',
      category: 'guidance-question',
