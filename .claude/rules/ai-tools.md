...
> **스킬 경로**: Claude SSOT = `.claude/skills/` | Gemini 스캔 경로 = `.gemini/skills/` (gitignored symlink, 로컬 전용) | Codex staging = `.agents/skills/` → `npm run skills:sync:codex` → `~/.codex/skills/`
