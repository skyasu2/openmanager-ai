...
- `ZAI_API_KEY`, `ZAI_DEFAULT_MODEL` (Z.AI GLM Flash — Reporter primary)
...
- 응답에서 `groq/cerebras/mistral/zai/gemini/openrouter` 모두 `true`인지 확인
...
- 2026-05-21: v2.2.0 - Z.AI(`ZAI_API_KEY`, `ZAI_DEFAULT_MODEL`) 및 Upstash env 추가, provider health 체크에 `zai` 포함
