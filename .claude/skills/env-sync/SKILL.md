...
5. Cloud Run env 확인 (AI 장애 시).
- AI provider 상태: `curl -s https://ai-engine-490817238363.asia-northeast1.run.app/health`
- 응답에서 `groq/cerebras/mistral/gemini/openrouter` 모두 `true`인지 확인
- Cloud Run 재배포로 시크릿 반영: `cd cloud-run/ai-engine && ./deploy.sh`
