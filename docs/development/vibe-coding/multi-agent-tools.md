...
│  └──────────────┘  └──────────────┘  └──────────────┘  │
│                                                         │
│   Codex 중심으로 구현하고, Claude Code/Gemini를          │
...
### 역할
- **병행 개발/리뷰 AI**: 코드 검토, 대안 제시, 복잡 맥락 보완
- **대화형 인터페이스**: 자연어로 요청
...
```
기본 운영: Codex를 메인 개발 도구로 두고, Claude Code/Gemini를 수동 전환하며 교차 사용
...
- `Codex 메인 + Claude Code/Gemini 수동 교차 사용`
...
| 작업 | 추천 AI | 이유 |
|------|---------|------|
| 코드 작성 | Codex | 메인 구현과 bounded refactor |
