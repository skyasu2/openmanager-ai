...
|------------------|-----------|----------|--------|
| **Cerebras** | Orchestrator·Analyst·Reporter·Advisor·Verifier primary, Groq-first agents fallback | Qwen/llama runtime chain은 2026-05-27 종료 예정이라 post-deprecation replacement와 계정 entitlement를 함께 추적. 16K/32K context floor 경로는 8K fallback을 건너뜀 | ⚠️ |
