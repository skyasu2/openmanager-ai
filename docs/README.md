...
| AI Engine/Agent가 어떻게 동작하는가 | [AI Agent Design](./design/01-ai-agent-design.md), [AI Engine Architecture](./reference/architecture/ai/ai-engine-architecture.md) |
| API route가 실제로 존재하는가 | [API Endpoints](./reference/api/endpoints.md), `npm run docs:api:endpoints:check` |
| API/stream/job 계약이 무엇인가 | [API Design](./design/02-api-design.md), [API Contracts](./reference/api/contracts.md) |
| Dashboard와 AI가 같은 데이터를 보는가 | [Data Flow](./architecture/04-data-flow.md), [Data Consistency Strategy](./reference/architecture/design/consistency.md) |
