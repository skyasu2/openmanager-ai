...
| Approval workflow | `approval_history` (0행) — Cloud Run approval service가 사용, 현재 비활성 |
...
| `approval_history` | 0 | ⚠️ 비활성 | 사용 여부 확인 필요 (S-5) |
| `incident_reports` | 2 | ⚠️ 확인 필요 | 런타임 사용 여부 검증 |
