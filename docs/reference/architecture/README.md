...
| AI Domain Portability | [ai/domain-portability.md](./ai/domain-portability.md) | Active Reference | `AssistantDomain` + frontend artifact registry 포팅 기준 | 새 AI 도메인 shell, artifact renderer/executor 등록 경계 변경 |
