...
|----------|----------------|------|-----------|
| **Cerebras** | Supervisor, NLQ, Analyst, Orchestrator | `gpt-oss-120b` (120B MoE, 5.1B active) | 핵심 질의 경로 담당. 무료/저비용 정책과 처리량은 공급사 정책 변동 가능 |
...
| **MoE(gpt-oss-120b) 활용성** | 강함 | Supervisor/NLQ/Analyst/Orchestrator의 핵심 텍스트 추론 경로를 Cerebras primary로 집중 배치 |
