...
import { getMonitoringResourceCatalog } from '../../domains/monitoring/resource-catalog';
import { createMonitoringSystemPrompt } from '../../domains/monitoring/supervisor-prompt';
