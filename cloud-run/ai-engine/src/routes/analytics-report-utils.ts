...
interface MonitoringGroundingForReport {
...
function maxSeverity(current: string, candidate: string): string {
...
function enrichWithMonitoringGrounding(
  data: ToolBasedData,
