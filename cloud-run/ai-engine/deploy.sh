...
DEPLOY_CMD=(
  ...
  --cpu-throttling
  --no-session-affinity
  --set-env-vars "NODE_ENV=production,BUILD_SHA=${SHORT_SHA},DEFAULT_ORIGIN=${DEFAULT_ORIGIN},ALLOWED_ORIGINS=${ALLOWED_ORIGINS},ALLOW_DEGRADED_SINGLE=true,CEREBRAS_TOOL_CALLING_ENABLED=${CEREBRAS_TOOL_CALLING_ENABLED:-true},CEREBRAS_LONG_CONTEXT_ENABLED=${CEREBRAS_LONG_CONTEXT_ENABLED:-true}"
