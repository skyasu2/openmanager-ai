...
CEREBRAS_MODEL_ID="${CEREBRAS_MODEL_ID:-llama3.1-8b}"
...
DEPLOY_CMD=(
  ...
  --cpu-throttling
  --no-session-affinity
  --set-env-vars "NODE_ENV=production,BUILD_SHA=${SHORT_SHA},DEFAULT_ORIGIN=${DEFAULT_ORIGIN},ALLOWED_ORIGINS=${ALLOWED_ORIGINS},ALLOW_DEGRADED_SINGLE=true,CEREBRAS_MODEL_ID=${CEREBRAS_MODEL_ID},CEREBRAS_FALLBACK_MODEL_IDS=${CEREBRAS_FALLBACK_MODEL_IDS},CEREBRAS_TOOL_CALLING_ENABLED=${CEREBRAS_TOOL_CALLING_ENABLED:-true},CEREBRAS_LONG_CONTEXT_ENABLED=${CEREBRAS_LONG_CONTEXT_ENABLED:-true},CLOUD_TASKS_ENABLED=${CLOUD_TASKS_ENABLED:-false},CLOUD_TASKS_PROJECT_ID=${CLOUD_TASKS_PROJECT_ID:-$PROJECT_ID},CLOUD_TASKS_LOCATION=${CLOUD_TASKS_LOCATION:-$REGION},CLOUD_TASKS_QUEUE_ID=${CLOUD_TASKS_QUEUE_ID:-openmanager-ai-jobs},CLOUD_TASKS_SERVICE_ACCOUNT_EMAIL=${CLOUD_TASKS_SERVICE_ACCOUNT_EMAIL:-},CLOUD_TASKS_OIDC_AUDIENCE=${CLOUD_TASKS_OIDC_AUDIENCE:-},CLOUD_TASKS_DISPATCH_DEADLINE_SECONDS=${CLOUD_TASKS_DISPATCH_DEADLINE_SECONDS:-600}"
