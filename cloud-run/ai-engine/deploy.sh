...
DEPLOY_CMD=(
  ...
  --cpu-throttling
  --no-session-affinity
  --set-env-vars "NODE_ENV=production,BUILD_SHA=${SHORT_SHA},DEFAULT_ORIGIN=${DEFAULT_ORIGIN},ALLOWED_ORIGINS=${ALLOWED_ORIGINS},GRAPH_RAG_TELEMETRY_SAMPLE_RATE=0.1,ALLOW_DEGRADED_SINGLE=true"
