...
> Canonical: reports/planning/nivo-chart-ux-fix-plan.md
...
- [ ] Playwright: storage-nfs-dc1-01 성능 분석 탭
  - 차트 hover → 툴팁 팝업 표시 확인
  - 이상 구간 하이라이트 rect 표시 확인
