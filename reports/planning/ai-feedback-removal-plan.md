...
### 완전 삭제 파일
- [ ] `src/app/api/ai/feedback/route.ts` (225줄)
- [ ] `src/app/api/ai/feedback/` 디렉토리
- [ ] `src/hooks/ai/core/useChatFeedback.ts` (48줄)
- [ ] `src/schemas/ai-feedback.ts` (87줄)
- [ ] `cloud-run/ai-engine/src/routes/feedback.ts` (193줄)
...
- [ ] Phase 1: failing test 커밋
- [ ] Phase 2 Step 1~5: 제거 구현
- [ ] Phase 3: type-check, lint, test:quick, knip:ci 전부 통과
- [ ] `src/app/api/ai/feedback/` 디렉토리 미존재 확인
