...
> Canonical: reports/planning/archive/ai-feedback-removal-plan.md
...
- [x] production 배포 후 `/api/ai/feedback` 404 확인
...
완료
  ├─ v8.11.113 release/tag 배포
  ├─ GitLab tag pipeline 2506061682 success 확인
  ├─ Vercel /api/ai/feedback GET/POST 404 확인
  ├─ Cloud Run /api/ai/feedback GET/POST 404 확인
  └─ AI Assistant production UI에서 feedback action 제거 및 copy/regenerate 유지 확인
```
