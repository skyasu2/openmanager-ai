...
- 잔여 범위: AI Engine runtime 변경은 아직 production 이미지에 반영되지 않았으므로 `v8.11.160` release/tag 배포 판단.
...
3. 다음 단계는 AI Engine runtime 변경을 production 이미지에 반영하기 위한 `v8.11.160` release/tag 배포 판단.
