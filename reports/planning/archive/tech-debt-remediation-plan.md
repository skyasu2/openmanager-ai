...
> **완료**: 2026-05-11 `npm run docs:budget` 기준 72/90에서 신설 가능 확인 후 작성.
...
모든 Task 완료 시:
1. [x] 각 Task 체크박스 `[x]` 완료
2. [x] `TODO.md` Backlog 항목 완료 이력으로 이동
3. [x] 이 계획서 → `reports/planning/archive/tech-debt-remediation-plan.md` 이동
4. [x] 의존성 버전 변경 커밋 메시지에 `[DEPS]` 태그 포함
