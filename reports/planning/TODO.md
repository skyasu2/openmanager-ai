...
**Last Updated**: 2026-05-22 KST (v8.12.5 Playwright MCP 신규 6문항 QA 완료 — 서버 1:1 비교 수치 오류·Reporter 기준 불일치·심층 분석 generic 3개 신규 개선 항목 도출, QA-20260522-0559)
...
| Evidence Provider 라우팅·응답 품질 개선 | P2 | 2026-05-22 v8.12.5 QA(QA-20260522-0558/0559) 발견. H-1: `monitoringCapacityForecastEvidenceProvider` 불일치 라우팅, H-2: `monitoringPeakMetricEvidenceProvider` 응답 내용 부실. **신규 Task I**: I-1 서버 1:1 비교 쿼리 deterministic 경로, I-2 심층 분석 도메인 특성 힌트, I-3 Reporter 기준 명시는 모두 local implementation 완료. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) Task H/I |
