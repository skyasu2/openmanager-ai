...
**Last Updated**: 2026-05-22 KST (v8.12.6 AI Engine monitoring evidence review fixes deployed)
...
|------|----------|--------|-------|
| AI 품질 개선 (grounded KRL QA·intentFrame 관찰·Z.AI 안정성) | High | In Progress (tracking) | 2026-05-22 v8.12.5 Playwright MCP 신규 6문항 QA(`QA-20260522-0559`) 완료. 4 PASS / 2 PARTIAL. I-1 서버 1:1 비교 deterministic 경로, I-2 역할별 RCA 힌트, I-3 Reporter 영향 범위 기준, H-1 capacity forecast, H-2 peak metric deterministic answer는 모두 구현 후 v8.12.6으로 배포 완료. Review follow-up `06309822c`에서 `parseThreshold` 현재/과거 퍼센트 guard, 서버 ID case-insensitive exact match, retired `mode_multi_analysis_mode` label 제거를 반영했다. v8.12.6 tag pipeline `2545506889` success, Cloud Run `ai-engine-00508-4bv` 100% traffic. 잔여: intentFrame 실측 적중률, Task F 최종 판정, 다음 production QA 사용자-facing 재확인. Task E SDD Approved. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) |
...
| Evidence Provider 라우팅·응답 품질 개선 | P2 | 2026-05-22 v8.12.6 배포 완료. H-1 `monitoringCapacityForecastEvidenceProvider`, H-2 `monitoringPeakMetricEvidenceProvider`, I-1 서버 1:1 비교 deterministic 경로, I-2 심층 분석 도메인 특성 힌트, I-3 Reporter 기준 명시와 review follow-up 3건까지 반영. 잔여는 다음 production QA 재확인이다. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) Task H/I |
