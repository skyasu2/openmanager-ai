...
|------|----------|--------|-------|
| AI 어시스턴트 개선 — intentFrame 연결·세션 메모리·KRL seed | High | Draft | A1(P1): getIntentCategory에 intentFrame 신호 미반영 — Groq RPD 낭비. A2(P2): sessionId 생성 전략 불명, 세션 연속성 미검증. A3(P3): KRL security 1건·architecture 5건 부족. 상세: [ai-assistant-improvement-plan.md](ai-assistant-improvement-plan.md) |
