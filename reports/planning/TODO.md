...
**Last Updated**: 2026-05-22 KST (QA-20260522-0562 v8.12.7 7문항 평가 반영)
...
|------|----------|--------|-------|
| AI 품질 개선 (grounded KRL QA·intentFrame 관찰·Z.AI 안정성) | High | In Progress (tracking) | 2026-05-22 v8.12.5 Playwright MCP 신규 6문항 QA(`QA-20260522-0559`) 완료. 4 PASS / 2 PARTIAL. I-1 서버 1:1 비교 deterministic 경로, I-2 역할별 RCA 힌트, I-3 Reporter 영향 범위 기준, H-1 capacity forecast, H-2 peak metric deterministic answer는 모두 구현 후 v8.12.6으로 배포 완료. H-3 capacity forecast 표현 다양성("100% 도달 시점", "포화 예측", "가득 찰까"), 영어+오타 metric 입력, Redis 설정 가이드 KRL routing은 failing spec 선행 후 v8.12.7로 배포 완료했고 `QA-20260522-0562`에서 capacity/metric-trend 4 PASS를 확인했다. H-4 DC1/DC2 비교, "조치 시급한 서버" 운영 우선순위, CPU "위험 수준 도달" capacity 표현은 local 구현/검증 완료 후 커밋 대기. 잔여: H-4 배포/production QA 여부 판단, H-5 semantic-router-v2/fail-closed 구조 개선 SDD, intentFrame 실측 적중률, Task F 최종 판정. Task E SDD Approved. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) |
...
| Semantic router v2 / monitoring evidence fail-closed | P2 | H-3/H-4처럼 문장별 regex를 누적하는 방식은 장기 해법이 아니므로, `intentFrame.capabilityId + slots` 우선 provider 선택과 evidence 없는 monitoring 수치 답변 fail-closed 계약을 SDD로 설계한다. Supabase/DB 추가 사용 없이 기존 semantic metadata/domain evidence 경계에서 우선 검토. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) H-5 |
