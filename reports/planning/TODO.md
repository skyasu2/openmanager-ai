...
| AI 어시스턴트 설계 정비 (resume 불일치·CB 누락·라우팅 중복 등) | High | Approved | 정적 분석으로 발견한 Critical 2건·Major 4건·Minor 4건. 2026-05-20 Task 1-C, Task 2-B+1-A, Task 2-A, Task 2-C, Task 1-B(stream/v2 in-memory CB)를 SDD 순서로 구현했다. 남은 우선순위는 P3 dead-code/API surface 정리(Task 3-A~3-D)다. 상세: [ai-assistant-design-cleanup-plan.md](ai-assistant-design-cleanup-plan.md) |
