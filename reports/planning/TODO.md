...
| AI 어시스턴트 UX 개선 — 헤더 단순화·버블·분석근거·스크롤·에이전트 배지 (T1~T7) | High | Approved (Codex 위임 대기) | Phase1(T1/T5/T2) → Phase2(T4/T6/T7) → Phase3(T3 동적 웰컴). 상세: [ai-assistant-ux-improvement-plan.md](ai-assistant-ux-improvement-plan.md) |
