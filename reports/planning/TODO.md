...
**Last Updated**: 2026-05-22 KST (v8.12.5 QA 후속 H-1 capacity forecast 라우팅·threshold/target 파싱 local implementation 완료)
...
| Evidence Provider 라우팅·응답 품질 개선 | P2 | 2026-05-22 v8.12.5 QA(QA-20260522-0558/0559) 발견. H-1 `monitoringCapacityForecastEvidenceProvider` 불일치 라우팅은 local implementation 완료. H-2 `monitoringPeakMetricEvidenceProvider` 응답 내용 부실은 잔여. **신규 Task I**: I-1 서버 1:1 비교 쿼리 deterministic 경로, I-2 심층 분석 도메인 특성 힌트, I-3 Reporter 기준 명시는 모두 local implementation 완료. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) Task H/I |
