...
| AI Assistant Analyst/Reporter quality improvement | P1 | Draft | Plan: [ai-assistant-analyst-reporter-quality-plan.md](ai-assistant-analyst-reporter-quality-plan.md). 2026-04-27 production QA 기준 Analyst `→ --` 예측 표시와 설명 없는 low-value 주요 이슈를 정리하고, Reporter 접힌 카드의 다음 조치 요약을 보강한다. |
