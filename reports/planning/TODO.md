...
|------|----------|--------|-------|
| AI 품질 개선 (grounded KRL QA·intentFrame 관찰·Z.AI 안정성) | High | In Progress (Codex) | 2026-05-22 v8.12.9 H-4 배포 및 targeted production QA(`QA-20260522-0563`) 완료. DC1/DC2 비교, "조치 시급한 서버" 운영 우선순위, CPU "위험 수준 도달" capacity 표현은 deterministic evidence 경로 3/3 PASS. 잔여: H-5 semantic-router-v2/fail-closed 구조 개선 SDD/구현, intentFrame 실측 적중률, Task F 최종 판정. Task E/H-5 SDD Approved. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) |
...
| Semantic router v2 / monitoring evidence fail-closed | P2 | 2026-05-22 H-5 SDD Approved. 구현 전 `test(spec):` failing regression seed 커밋 필요. Supabase/DB 추가 사용 없이 domain capability metadata와 supervisor domain evidence 경계에서 처리. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) H-5 |
