...
**Last Updated**: 2026-05-22 KST (QA-20260522-0563 v8.12.9 H-4 production QA 반영)
...
|------|----------|--------|-------|
| AI 어시스턴트 v8.12.16 QA 후속 개선 (Advisor routing·healthy filter·lowest load·markdown) | High | In Progress (Codex) | 2026-05-24 `QA-20260524-0572`에서 확인된 P1~P3 로컬 구현·검증 완료. Advisor routing, healthy-only evidence, composite-load lowest ranking, compact markdown heading 렌더링을 반영했다. 배포/production QA 판단 대기. 상세: [ai-assistant-improvement-plan-v8.12.16.md](ai-assistant-improvement-plan-v8.12.16.md) |
...
| Semantic router v2 / monitoring evidence fail-closed | P2 | 2026-05-22 H-5 SDD Approved, failing spec 선행, local 구현·검증 완료. Supabase/DB/LLM 추가 호출 없이 domain capability metadata와 supervisor domain evidence 경계에서 처리. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) H-5 |
