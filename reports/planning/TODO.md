...
|------|----------|--------|-------|
| AI 품질 개선 (grounded KRL QA·intentFrame 관찰·Z.AI 안정성) | High | In Progress (tracking) | 2026-05-22 v8.12.5 Playwright MCP 신규 6문항 QA(`QA-20260522-0559`) 완료. 4 PASS / 2 PARTIAL. **신규 발견**: I-1 서버 1:1 비교 쿼리가 일반 대화 경로로 라우팅되어 수치 오류 발생(82%→92%), I-2 심층 원인 분석이 generic 결과 반환(도메인 특성 미반영), I-3 Reporter 경고 기준 대시보드 불일치(1대 vs 4대). 이전 상태: v8.12.4 5문항 QA → v8.12.5 3개 이슈 수정 배포 완료. v8.12.5 GitLab pipeline `2545042099` success. 잔여: intentFrame 실측 적중률, Task I(신규) 구현. Task E SDD Approved. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) |
...
| Evidence Provider 라우팅·응답 품질 개선 | P2 | 2026-05-22 v8.12.5 QA(QA-20260522-0558/0559) 발견. H-1: `monitoringCapacityForecastEvidenceProvider` 불일치 라우팅, H-2: `monitoringPeakMetricEvidenceProvider` 응답 내용 부실. **신규 Task I**: I-1 서버 1:1 비교 쿼리 deterministic 경로 미확립(P1), I-2 심층 분석 도메인 특성 미주입(P2), I-3 Reporter·대시보드 경고 기준 불일치(P3). SDD Draft 작성 후 구현. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) Task H/I |
