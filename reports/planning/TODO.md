...
**Last Updated**: 2026-04-18 KST (OTel Phase 3-B AZ3 Redis slice 완료)
...
| OTel 토폴로지 개선 (Phase 3) | Medium | 계획서: [otel-topology-improvement-plan.md](otel-topology-improvement-plan.md). Phase 3-A `lb-haproxy-dc1-03`, Phase 3-B `cache-redis-dc1-03` 완료. 남은 실질 backlog는 `storage-nfs-dc1-02`와 필요 시 precomputed-state 재생성. |
