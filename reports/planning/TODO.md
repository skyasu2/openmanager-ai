...
| AI 어시스턴트 설계 정비 (resume 불일치·CB 누락·라우팅 중복 등) | High | Approved | 정적 분석으로 발견한 Critical 2건·Major 4건·Minor 4건. 2026-05-20 Task 1-B를 Critical→Major/P2로 재분류(Cloud Run multi-provider rotation이 실질 fault tolerance 담당). Task 1-C, Task 2-B+1-A, Task 2-A를 SDD 순서로 구현했다. 다음 우선순위는 P2 Task 1-B(stream/v2 CB) 또는 Task 2-C(route 주석 업데이트)다. 상세: [ai-assistant-design-cleanup-plan.md](ai-assistant-design-cleanup-plan.md) |
