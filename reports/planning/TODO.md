...
| NLQ Pre-processing Redesign (5건) | High | Approved | N0~N4 계약 승인. N4(stream/v2 출력 필터) 추가, P6는 N1/N3에서 해소, P7/P8은 별도 추적. 실행 순서: N0 → N2/N4 병렬 가능 → N1 → N3. 상세: [nlq-preprocessing-redesign-plan.md](nlq-preprocessing-redesign-plan.md) |
