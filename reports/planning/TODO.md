...
| NLQ Pre-processing Redesign (5건) | High | In Progress (Codex) | N0 채팅 입력 10,000자 UX guard 완료. 다음 실행 순서: N2/N4 병렬 가능 → N1 → N3. P6는 N1/N3에서 해소, P7/P8은 별도 추적. 상세: [nlq-preprocessing-redesign-plan.md](nlq-preprocessing-redesign-plan.md) |
