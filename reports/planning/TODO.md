...
**Last Updated**: 2026-05-17 KST (AI 어시스턴트 UX Phase 2 진행)
...
| AI 어시스턴트 UX 개선 — 헤더 단순화·버블·분석근거·스크롤·에이전트 배지 (T1~T7) | High | In Progress (Codex) | Phase1(T1/T5/T2)·Phase2(T4/T6/T7) 코드 반영 및 로컬 검증 완료. 남은 범위는 Phase3(T3 동적 웰컴). 상세: [ai-assistant-ux-improvement-plan.md](ai-assistant-ux-improvement-plan.md) |
