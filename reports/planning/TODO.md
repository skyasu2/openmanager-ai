...
**Last Updated**: 2026-05-22 KST (v8.12.5 2차 QA routing follow-up local implementation 완료)
...
| Evidence Provider 라우팅·응답 품질 개선 | P2 | 2026-05-22 v8.12.6 배포 완료분에 더해 H-3 capacity forecast 표현/영어 오타/KRL Redis 설정 가이드 routing follow-up local implementation 완료. 잔여는 배포와 다음 production QA 재확인이다. 상세: [ai-quality-improvement-plan-2026-05.md](ai-quality-improvement-plan-2026-05.md) Task H/I |
