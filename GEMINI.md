...
스킬 수정 전에는 `docs/development/vibe-coding/skills.md`와 `config/ai/skill-baselines.json`을 먼저 확인하고, 변경 후 `npm run skills:check`를 실행합니다.
...
- **Modern Stack Mastery**: Leverage the full potential of React 19.2.6, Next.js 16.1.6, and TypeScript 6.0.3 features.
