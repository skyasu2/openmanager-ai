...
SPEC="tests/manual/ai-thinking-visualizer.spec.ts"
...
run_once() {
  ...
  PLAYWRIGHT_MANUAL_TRACE_MODE="${PLAYWRIGHT_MANUAL_TRACE_MODE:-on}" \
...
echo "Running Vercel thinking visualizer QA on channel: $CHANNEL"
